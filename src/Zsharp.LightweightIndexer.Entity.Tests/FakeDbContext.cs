namespace Zsharp.LightweightIndexer.Entity.Tests
{
    ...
    sealed class FakeDbContext : DbContext
    {
        ...
        protected override void ConfigureBlock(EntityTypeBuilder<Block> builder)
        {
            ...
            builder.Property(b => b.Hash).HasConversion(Converters.UInt256ToBytesConverter);
            builder.Property(b => b.MerkleRoot).HasConversion(Converters.UInt256ToBytesConverter);
        ...
        protected override void ConfigureBlockTransaction(EntityTypeBuilder<BlockTransaction> builder)
        {
            ...
            builder.Property(j => j.BlockHash).HasConversion(Converters.UInt256ToBytesConverter);
            builder.Property(j => j.TransactionHash).HasConversion(Converters.UInt256ToBytesConverter);
        }
        ...
        protected override void ConfigureElysiumTransaction(EntityTypeBuilder<ElysiumTransaction> builder)
        {
            ...
            builder.Property(t => t.TransactionHash).HasConversion(Converters.UInt256ToBytesConverter);
        }
        ...
        protected override void ConfigureInput(EntityTypeBuilder<Input> builder)
        {
            ...
            builder.Property(i => i.OutputHash).HasConversion(Converters.UInt256ToBytesConverter);
            builder.Property(i => i.Script).HasConversion(Converters.ScriptToBytesConverter);
            builder.Property(i => i.TransactionHash).HasConversion(Converters.UInt256ToBytesConverter);
        }
        ...
        protected override void ConfigureMtpData(EntityTypeBuilder<MtpData> builder)
        {
            ...
            builder.Property(m => m.BlockHash).HasConversion(Converters.UInt256ToBytesConverter);
            builder.Property(m => m.Hash).HasConversion(Converters.UInt256ToBytesConverter);
            builder.Property(m => m.Reserved1).HasConversion(Converters.UInt256ToBytesConverter);
            builder.Property(m => m.Reserved2).HasConversion(Converters.UInt256ToBytesConverter);
        }
        ...
        protected override void ConfigureOutput(EntityTypeBuilder<Output> builder)
        {
            ...
            builder.Property(o => o.TransactionHash).HasConversion(Converters.UInt256ToBytesConverter);
        ...
        protected override void ConfigureTransaction(EntityTypeBuilder<Transaction> builder)
        {
            ...
            builder.Property(t => t.Hash).HasConversion(Converters.UInt256ToBytesConverter);
        }
    }
}
