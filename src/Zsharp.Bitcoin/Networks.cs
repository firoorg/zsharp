namespace Zsharp.Bitcoin
{
    ...
    public sealed class Networks : NetworkSetBase
    {
        private Networks()
        {
        }

        public static Networks Default { get; } = new Networks();
        ...
        protected override NetworkBuilder CreateMainnet()
        {
            ...
            builder.SetConsensus(new Consensus()
            {
                ...
                ConsensusFactory = new ConsensusFactory(DateTimeOffset.FromUnixTimeSeconds(1544443200)),
        ...
        protected override NetworkBuilder CreateRegtest()
        {
            ...
            {
                CoinbaseMaturity = 100,
                ConsensusFactory = new ConsensusFactory(DateTimeOffset.MaxValue),
                MajorityEnforceBlockUpgrade = 750,
                MajorityRejectBlockOutdated = 950,
                MajorityWindow = 1000,
        ...
        protected override NetworkBuilder CreateTestnet()
        {
            ...
            builder.SetConsensus(new Consensus()
            {
                ...
                CoinbaseMaturity = 100,
                ConsensusFactory = new ConsensusFactory(DateTimeOffset.FromUnixTimeSeconds(1539172800)),
